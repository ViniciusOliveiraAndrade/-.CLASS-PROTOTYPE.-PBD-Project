...
public class CTDevolverEmprestimo implements ActionListener{
	...
	public void actionPerformed(ActionEvent e) {
		JOptionPane.showMessageDialog(this.tela, "Sua multa � de R$"+this.ec.devolverEmprestimo(EmprestimoDAO.getById(Integer.parseInt(this.tela.getIdEmprestimoF().getText())), this.tela.getFuncionarioLogado())+"0");
	}
}
